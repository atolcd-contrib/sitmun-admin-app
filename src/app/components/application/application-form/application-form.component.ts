import { ApplicationService } from './../../../domain/application/services/application.service';
...
export class ApplicationFormComponent extends BaseFormComponent<ApplicationProjection> {
  ...
  headerParamsSection: Array<any> = [
    this.utils.getTranslate('applicationEntity.headerLeftSection'),
    this.utils.getTranslate('applicationEntity.headerRightSection')
  ];
  headerParams = {
    headerLeftSection: {
      logoSitmun: {
    ...
    let defineNewHeaderParamDialog = DataTableDefinition.builder<ApplicationHeaderParameter, ApplicationHeaderParameter>(this.dialog, this.errorHandler)
      ...
      .withTemplateDialog('newHeaderParamDialog', () => {
        ...
        return TemplateDialog.builder()
          ...
          .withTitle(this.translateService.instant('applicationEntity.navigationHeaderConfigurationTitle'))
          .withForm(
            new FormGroup({
              name: new FormControl('', {
                validators: [Validators.required],
      ...
      .withTargetsTitle(this.translateService.instant('applicationEntity.navigationHeaderConfigurationTitle'))
  ...
  private getAllHeaderParams = (): Observable<ApplicationHeaderParameter[]> => {
    ...
    Object.entries(headerLeft).forEach(([key, value]: any) => {
      ...
      object.section = this.utils.getTranslate('applicationEntity.headerLeftSection');
      result.push(object);
    });
    ...
    Object.entries(headerRight).forEach(([key, value]: any) => {
      ...
      object.name = key;
      object.visible = value.visible;
      object.section = this.utils.getTranslate('applicationEntity.headerRightSection');
      result.push(object);
    });
